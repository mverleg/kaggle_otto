...
def make_pretrain(pretrain_path, data, labels, minimum_train_loss = 0.7, normalize_log = True, extra_feature_count = 57,
		extra_feature_seed = 0, **params):
	...
	data, tmp = chain_feature_generators(data, labels, data, extra_features = extra_feature_count, multiplicity = 3, seed = extra_feature_seed)
