...
params = {
	...
	'dense2_size': 0,
	'dense3_size': None,
	'learning_rate': 0.0001,            # initial learning rate (learning rate is effectively higher for higher momentum)
	...
	'weight_decay': 0.00005,            # constrain the weights to avoid overfitting
