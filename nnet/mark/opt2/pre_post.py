...
from utils.postprocess import rescale_prior, scale_to_priors
...
#exit()
validator = SampleCrossValidator(train_data, true_classes, rounds = 7, test_frac = 0.2, use_data_frac = 1)
