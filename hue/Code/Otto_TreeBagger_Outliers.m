function Otto_TreeBagger_Outliers(pathIn, K, outlierOpt)
% train TreeBagger
% input:
...
%   K           pair of data for significance testing 
    ...
    fprintf('TreeBagger: numTree %d, removing outlier using ', nTree);
    if outlierOpt>1
        fprintf(' threshold=%d\n', outlierOpt);
    else
    ...
    for k=1:K
        ...
        [trainData, ~] = removeOutliersMahal(outlierOpt, trainData);
