...
max_features = ['sqrt', 'log2', None] #sqrt seems good (default), None is about as good but much slower
max_depth = [None, 75, 100, 200, 300] #at least higher than 20
...
outlier_frac = [False, 0.03, 0.06]
outlier_method = ['EE', 'OCSVM']
undersample = [False,True]
...
testparams.update( {"outlier_frac" : outlier_frac, "outlier_method" : outlier_method, "undersample" : undersample, "rescale_pred" : rescale_pred, "sample_weight" : sample_weight } )
